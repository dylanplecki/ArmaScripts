...
{
	class st_acre_volume {
        clientInit = "call compile preprocessFileLineNumbers 'x\st\addons\st_acre_volume\fn_clientInit.sqf'";
		serverInit = "['ACRE_CURVE_MODEL_SELECTABLE_B'] call acre_api_fnc_setCurveModel;";
    };
};
...
class RscTitles
{
	class st_acre_VolumeAdjustDialog 
	{
		idd = 10568; 
		movingEnable = 1; 
		enableSimulation = 1;
		...
		onLoad = "st_acre_VolumeAdjustDialog_Var = _this"; 
